...
### software source
## Beaglei: https://faculty.washington.edu/browning/beagle
...
### Steps
for chromosome in {1..21}; do
	
	## generate phased VCF by Beagle
	java -jar beagle.16May19.351.jar gt=chr${chromosome}.${pop}.snp.vcf.gz out=chr${chromosome}.${pop}.phased;
